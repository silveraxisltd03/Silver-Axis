...
import { SERVICES_FAQ } from '../services.data';

export function ServicesFaq() {
  const baseId = useId();
  const [openId, setOpenId] = useState<string | null>(SERVICES_FAQ[0]?.id ?? null);

  return (
    <section className="services-faq section-x" aria-labelledby="services-faq-heading">
      <div className="container">
        <span className="services-faq__eyebrow">Silver Axis answers</span>
        <h2 id="services-faq-heading" className="section-heading services-faq__title">
          Services questions.
        </h2>
